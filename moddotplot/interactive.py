            ...
            if "xaxis.range[0]" in relayoutData:
                ...
                if x_start_range >= 0 and y_start_range >= 0:
                    ...
                    if new_yy > len(image_pyramid) - 1:
                        ...
                        current_fig.update_xaxes(
                            nticks=10, title_text=x_name, title_font=dict(size=18)
                        )
                        ...
                        current_fig.update_yaxes(
                            title_text=y_name, title_font=dict(size=18)
                        )
                        current_fig.update_layout(
                            hoverlabel=dict(
                                bgcolor="white", font_size=16, font_family="Helvetica"
                        ...
                        return (
                            ...
                            "",
                            f"Sparsity: {new_sparsity}",
                            f"Layer: {new_yy + 1}/{len(image_pyramid)}",
                        )
